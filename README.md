The code in the respository is designed to process and analyze files that have been generated by Suite2P following imaging of GCaMP signals. The files in the 'library' directory ate functions upon which the rest of the files depend and should be added withint the current search path in Matlab. The files in the top level directory cane be doownloaded and stored wherever you want on your local machine.
